...
// Make sure to install the library first, e.g., composer require mike42/escpos-php

// Inside your if (isset($_GET['print_order']) && $current_order_id > 0) block:
$printer = [
...
if ($printer) {
    ...
    if (!isset($prefactura_data)) {
        ...
        try {
            ...
            $printer_obj->text("Su Restaurante\n");
        ...
        <div class="column is-half">
            ...
            <?php if (!empty($detalle_orden_actual)): ?>
                ...
                <div class="buttons is-right">
                    ...
                    <a href="index.php?vista=create_order?mesa_id=<?php echo $mesa_id; ?>&orden_id=<?php echo $current_order_id; ?>" 
